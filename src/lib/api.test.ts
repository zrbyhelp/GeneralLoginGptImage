...
describe('callImageApi', () => {
  ...
  it('does not include client API configuration in the request body', async () => {
    ...
    expect(body).not.toHaveProperty('pricingRules')
    expect(body).not.toHaveProperty('pricingPreviewRules')
    expect(body).not.toHaveProperty('pricingBreakdown')
    expect(body).not.toHaveProperty('billingMode')
    expect(body).not.toHaveProperty('estimatedPoints')
    expect(body).not.toHaveProperty('costPerImage')
    expect(body).not.toHaveProperty('pointsPerImage')
    expect(body.params).not.toHaveProperty('apiKey')
    expect(body.params).not.toHaveProperty('pricingRules')
    expect(body.params).not.toHaveProperty('estimatedPoints')

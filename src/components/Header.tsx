        ...
        <div className="flex items-center gap-1">
          ...
          <div ref={userMenuRef} className="relative ml-1">
            <button
              ...
              className="flex h-9 max-w-40 items-center gap-2 rounded-full border border-white/70 bg-white/75 py-1 pl-1 pr-2 text-slate-700 shadow-sm shadow-slate-900/[0.04] transition-colors hover:bg-white dark:border-white/[0.1] dark:bg-white/[0.08] dark:text-slate-200 dark:hover:bg-white/[0.12]"
            >
              ...
              <span data-i18n-skip className="max-w-24 truncate text-xs font-medium sm:max-w-32 sm:text-sm">{userLabel}</span>
              <svg
